                    ...
                    <div class="row mb-32pt">
                        <div class="col-lg-4">
                            ...
                            <p class="card-subtitle text-70 mb-16pt mb-lg-0">
                                You can edit Subject Information to add Subejct.</br><a href="<?=site_url("admin/subjecttype")?>" style="font-weight: bold;">Show Subject Type Table</a>
                            </p>
                        </div>
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="flex" style="max-width: 100%">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required" id="name" name="name" placeholder="ex: Standard" value="<?=$record->subject_type?>">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Subject Type ID</label>
                                    <input type="text" class="form-control required" id="code" name="code" placeholder="Only Number" value="<?=$record->type_id?>">
                                </div>
                                <div class="form-group">
                    ...
                    <div class="row mb-32pt">
                        <div class="flex" style="max-width: 100%; position: absolute; right: 24px;">
                            <div class="button-list">
                                ...
                                <a href="<?=site_url("admin/subjecttype")?>">
                ...
                form.validate({
                    ...
                    submitHandler: function() {
                        ...
                        $.ajax({
                            ...
                            url: '<?=site_url('admin/updatesubjecttype')?>',
