                    ...
                    <div class="row mb-32pt">
                        <div class="col-lg-4">
                            ...
                            <p class="card-subtitle text-70 mb-16pt mb-lg-0">
                                You can edit Product Price(USD) to add Price.</br><a href="<?=site_url("admin/price")?>" style="font-weight: bold;">Show Price Table</a>
                            </p>
                        </div>
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="flex" style="max-width: 100%">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required" id="name" name="name" placeholder="Only Number(ex: 250)" value="<?=$record->price_usd?>">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Price ID</label>
                                    <input type="text" class="form-control required" id="code" name="code" placeholder="Only Number" value="<?=$record->price_id?>">
                                </div>
                                <div class="form-group">
                ...
                form.validate({
                    ...
                    submitHandler: function() {
                        ...
                        $.ajax({
                            ...
                            url: '<?=site_url('admin/updateprice')?>',
                            success: function(data)
                            {
                                swal({
                                    ...
                                    location.href = "<?=site_url('admin/price')?>";
                                });
