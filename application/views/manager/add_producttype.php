                    ...
                    <div class="row mb-32pt">
                        <div class="col-lg-4">
                            ...
                            <p class="card-subtitle text-70 mb-16pt mb-lg-0">
                                You can edit Product Type Information to add Product Type.</br><a href="<?=site_url("admin/producttype")?>" style="font-weight: bold;">Show Product Type Table</a>
                            </p>
                        </div>
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="flex" style="max-width: 100%">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required" id="name" name="name" placeholder="ex: QA">
                                </div>
                                <div class="form-group">
