                        ...
                        <div class="flex" style="max-width: 100%">
                            <div class="form-row">
                                ...
                                <div class="col-12 col-md-2 mb-2">
                                    ...
                                    <a href="<?=site_url("admin/newprice")?>">
                ...
                <div class="card mb-lg-32pt">
                    <div class="table-responsive" data-toggle="lists" data-lists-sort-by="js-lists-values-date" data-lists-sort-desc="true" data-lists-values='["js-lists-values-name", "js-lists-values-company", "js-lists-values-phone", "js-lists-values-date"]'>
                        <table id="price_table" class="table mb-0 thead-border-top-0 table-nowrap">
                            <thead>
                                <tr>
                        ...
                        ?>
                                <tr data-id="<?=$record->Id?>">
                                    ...
                                    <td><?=$i?></td>
                                    <td><?=$record->price_usd?>$</td>
                                    <td><?=$record->price_id?></td>
                                    <td><?=$record->validity?'<span class="badge bg-success">Active</span>':'<span class="badge bg-danger">Banned</span>'?></td>
                                    <td>
                                        <a href="<?=site_url("admin/edit-price/{$record->Id}")?>" class="btn btn-dark btn-circle btn-sm mr-2"><i class="material-icons list-icon">edit</i></a>
        ...
        <script>
            ...
            removeRow = function($_el) {
                ...
                $.ajax({
                    ...
                    url: '<?=site_url("admin/removeRowPrice")?>',
