                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="flex" style="max-width: 100%">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required" id="name" name="name" placeholder="ex: Standard">
                                </div>
                                <div class="form-group">
                ...
                form.validate({
                    ...
                    submitHandler: function() {
                        ...
                        $.ajax({
                            ...
                            url: '<?=site_url('admin/createsubjecttype')?>',
                            success: function(data)
                            {
                                swal({
                                    title: "",
                                    text: "Created New Subject Type"
                                }).then(function() {
