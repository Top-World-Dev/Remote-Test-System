                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="flex" style="max-width: 100%">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required" id="AssociationID" name="AssociationID" placeholder="ex: 200PS" value="<?=$record->association_id?>">
                                </div>
                                <div class="form-group">
                                ...
                                <?php
                                        ...
                                        {
                                ?>
                                            <option <?=$record->set_id == $generate->set_id?'selected':''?>><?=$generate->set_id?></option>
                                <?php
                                        }
                                ?>
                                    </select>
                ...
                form.validate({
                    ...
                    submitHandler: function() {
                        ...
                        $.ajax({
                            ...
                            url: '<?=site_url('admin/updateconnect')?>',
