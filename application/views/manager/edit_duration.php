                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="flex" style="max-width: 100%">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required" id="name" name="name" value="<?=$record->test_duration?>">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Unit</label>
                                    <select class="form-control required"  id="code" name="code">
                                        <option value="minutes">Minute</option>
                                        <option value="hours" <?=$record->unit == "hours" ? 'selected':''?>>Hour</option>
                                    </select>
                                </div>
                                <div class="form-group">
                ...
                form.validate({
                    ...
                    submitHandler: function() {
                        ...
                        $.ajax({
                            ...
                            url: '<?=site_url('admin/updateduration')?>',
